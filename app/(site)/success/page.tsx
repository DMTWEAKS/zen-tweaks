...
export const metadata = {
  ...
  description: "Thank you for your purchase. Your license key is on its way.",
};
    ...
    <section className="relative min-h-screen text-white py-16 sm:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-cyan-400" aria-hidden="true">
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6 hover:border-cyan-500/50 transition-colors">
            ...
            <a href="https://zen-tweaks.gitbook.io/zen-tweaks-setup-guide" target="_blank" rel="noopener noreferrer" className="inline-block mt-4 text-cyan-400 hover:text-cyan-300 text-sm font-medium transition-colors">
              View Setup Guide →
            </a>
          </div>
        ...
        <div className="mt-20 pt-12 border-t border-slate-800 text-center">
          ...
          <a href="https://discord.gg/zentweaks" target="_blank" rel="noopener noreferrer" className="inline-block text-cyan-400 hover:text-cyan-300 text-sm font-medium transition-colors mb-4">
