...
import TermsBody from "@/components/sections/legal/TermsBody";
  ...
  return (
    <section className="relative min-h-screen w-full" style={{ background: '#020308' }}>
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center gap-12 px-4 pt-[72px] pb-16 sm:gap-[92px] sm:px-8 sm:pb-[96px] lg:px-0">
        ...
        <LegalFooterNote
          agreementText="By using Zen Tweaks, you agree to these Terms of Service. If you have questions, please contact us through our official channels."
        />
      </div>
    </section>
  );
