        ...
        <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse;">
          ...
          <tr>
            <td style="padding: 40px; background-color: #141414; border-left: 1px solid rgba(63, 219, 255, 0.1); border-right: 1px solid rgba(63, 219, 255, 0.1);">
              ...
              <ol style="margin: 0 0 20px; padding-left: 20px; color: rgba(255, 255, 255, 0.7); font-size: 15px; line-height: 1.8;">
                <li>Download ZenTweaks from our <a href="https://zen-tweaks.gitbook.io/zen-tweaks-setup-guide/" style="color: #3fdbff; text-decoration: underline;">setup guide</a></li>
              ...
              <p style="margin: 20px 0 30px; color: rgba(255, 255, 255, 0.7); font-size: 15px; line-height: 1.6;">
                Join our Discord and open a ticket with your proof of purchase to get the customer role for enhanced support:<br>
                <a href="https://discord.gg/zentweaks" style="color: #3fdbff; text-decoration: underline;">https://discord.gg/zentweaks</a>
              </p>
...
Join our Discord and open a ticket with your proof of purchase to get the customer role for enhanced support:
https://discord.gg/zentweaks
...
export async function POST(req: NextRequest) {
  ...
  const now = Date.now();
  if (now - timestampInt > TOLERANCE_MS) {
